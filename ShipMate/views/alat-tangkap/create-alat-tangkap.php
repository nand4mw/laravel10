...
if(isset($_POST["submit"])) {
    $result = $AlatTangkapController->store($_POST);
...
<nav class="bg-teal-600 border-gray-200 px-2 h-20 flex items-center fixed w-full z-50">
  ...
  <?php if($success) : ?>
        ...
        <div class="bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-6 space-y-6">
                <p class="text-base leading-relaxed text-gray-500 dark:text-gray-400">
                    Alat Tangkap Sudah Berhasil DiCreate
                </p>
            </div>
            <!-- Modal footer -->
    ...
    <div class="relative w-1/3">
        ...
        <div class="bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-6 space-y-6">
                <p class="text-base leading-relaxed text-gray-500 dark:text-gray-400">
                    Terjadi kesalahan pada proses create alat tangkap
                </p>
  ...
  <img src="../../images/illustrations-13.svg" alt="" class="absolute -z-10 w-2/5 left-20 bottom-20 -rotate-6">
    <div class="w-1/3 flex flex-col gap-10 items-center">
        <p class="text-4xl font-bold text-gray-500">Create Alat Tangkap</p>
        <form action="" method="post" class="w-full flex flex-col items-center gap-6 shadow-lg p-6 bg-gray-50 rounded border-2">
        <div class="relative w-full">
            <input type="text" id="nama_alat_tangkap" class="block rounded-t-lg px-2.5 pb-2.5 pt-5 w-full text-sm text-gray-900 border-0 border-b-2 border-gray-300 appearance-none dark:border-gray-600 dark:focus:border-teal-500 focus:outline-none focus:ring-0 focus:border-teal-600 peer" placeholder=" " name="nama_alat_tangkap" autocomplete="off"/>

...
if(isset($_POST["submit"])) {
    $result = $DpiController->store($_POST);
...
<nav class="bg-teal-600 border-gray-200 px-2 h-20 flex items-center fixed w-full z-50">
  ...
  <?php if($success) : ?>
    ...
    <div class="relative w-1/3">
        ...
        <div class="bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-6 space-y-6">
                <p class="text-base leading-relaxed text-gray-500 dark:text-gray-400">
                    Terjadi kesalahan pada proses create DPI
                </p>
  ...
  <section class="w-full h-screen flex justify-center items-center relative">
    <img src="../../images/illustrations-8.svg" alt="" class="absolute -z-10 w-2/5 left-20">
    <div class="w-1/3 flex flex-col gap-10 items-center">
        ...
        <div class="relative w-full">
            <input type="text" id="nama_dpi" class="block rounded-t-lg px-2.5 pb-2.5 pt-5 w-full text-sm text-gray-900 border-0 border-b-2 border-gray-300 appearance-none dark:border-gray-600 dark:focus:border-teal-500 focus:outline-none focus:ring-0 focus:border-teal-600 peer" placeholder=" " name="nama_dpi" autocomplete="off"/>
